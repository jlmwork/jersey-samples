...
public class PersonResourceTest extends JerseyTest {
    ...
    protected TestContainerFactory getTestContainerFactory() throws TestContainerException {
        System.setProperty("jersey.config.test.container.factory", "org.glassfish.jersey.test.jetty.JettyTestContainerFactory");
        return super.getTestContainerFactory(); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    protected Application configure() {
        set(TestProperties.CONTAINER_FACTORY, "org.glassfish.jersey.test.jetty.JettyTestContainerFactory");
